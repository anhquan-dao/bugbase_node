...
class ESP32BugBase:
    ...
    def waitForHeader(self):
        ...
        while True:
            ...
            if(header1[1] == 0x79 and header2[1] == 0x56):
...
"""
        ...
        header = self.waitForHeader()
        # print("{} {}".format(hex(header[1][1] and)))
        if not header:
            print("No encoder header found!!!")
            return 10

        if header[0][1] == 0x6f and header[1][1] == 0x57:
            return 0
        elif header[0][1] == 0x78 and header[1][1] == 0x55:
            return 9
        elif header[0][1] == 0x79 and header[1][1] == 0x56:
            return 9
